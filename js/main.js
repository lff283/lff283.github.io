...
const add_id = "hmsqnmfjrrxb1djkfpbcokefmjitltdo"; // app_id
const app_secret = "J7yHmsvoo2c5h4r1z9nYztGptLmONlOH"; // app_secret
const key = "d3727c7475774212a4e23152db97f5ee" // key
function getWeather() {
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("你好&nbsp;今天&nbsp;!");
        $("#change1").html("告别昨天,珍惜今天,期待明天,展望未来.祝君身心安康,开心每一天!");
    }
});
